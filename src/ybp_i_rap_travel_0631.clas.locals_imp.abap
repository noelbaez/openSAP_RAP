...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD calculateTotalPrice.
    MODIFY ENTITIES OF yi_rap_travel_0631 IN LOCAL MODE
            ENTITY travel
  ...
  METHOD calculateTravelID.
    ...
    READ ENTITIES OF yi_rap_travel_0631 IN LOCAL MODE
      ENTITY Travel
  ...
  METHOD setInitialStatus.
    ...
    "Remove all instances with defined status
    DELETE travels WHERE TravelStatus IS NOT INITIAL.
    CHECK travels IS NOT INITIAL.

    "Set travel status to Open
    MODIFY ENTITIES OF yi_rap_travel_0631 IN LOCAL MODE
    ENTITY Travel
    UPDATE
     FIELDS ( TravelStatus ) WITH VALUE #( FOR travel IN travels ( %tky = travel-%tky
  ...
  METHOD validateAgency.
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-AgencyID IS INITIAL OR NOT line_exists( agencies_db[ agency_id = travel-AgencyID ] ).
        ...
        APPEND VALUE #( %tky        = travel-%tky
                        %state_area = 'VALIDATE_AGENCY'
                        %msg        = NEW ycm_rap_0631(
                                          severity = if_abap_behv_message=>severity-error
                                          textid   = YCm_rap_0631=>agency_unknown
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-CustomerID IS INITIAL OR NOT line_exists( customers_db[ customer_id = travel-CustomerID ] ).
        ...
        APPEND VALUE #(  %tky        = travel-%tky
                         ...
                         %msg        = NEW Ycm_rap_0631(
                                           severity   = if_abap_behv_message=>severity-error
                                           textid     = ycm_rap_0631=>customer_unknown
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-EndDate < travel-BeginDate.
        ...
        APPEND VALUE #( %tky               = travel-%tky
                        ...
                        %msg               = NEW ycm_rap_0631(
                                                 severity  = if_abap_behv_message=>severity-error
                                                 textid    = ycm_rap_0631=>date_interval
      ...
      ELSEIF travel-BeginDate < cl_abap_context_info=>get_system_date( ).
        ...
        APPEND VALUE #( %tky               = travel-%tky
                        ...
                        %msg               = NEW ycm_rap_0631(
                                                 severity  = if_abap_behv_message=>severity-error
                                                 textid    = ycm_rap_0631=>begin_date_before_system_date
                                                 begindate = travel-BeginDate )
  ...
  METHOD acceptTravel.
    ...
    ENTITY Travel
    UPDATE
    FIELDS ( TravelStatus ) WITH VALUE #( FOR key IN keys ( %tky = key-%tky
  ...
  METHOD recalcTotalPrice.
    ...
    LOOP AT travels ASSIGNING FIELD-SYMBOL(<travel>). "(<travel>).
...
*   We perform this for active (is_draft=00) as well as for drafts (is_draft=01) as we can't distinguish between edit or new drafts
      ...
      IF is_update_requested = abap_true.
        ...
        IF has_before_image = abap_true.
          ...
          IF update_granted = abap_false.
            APPEND VALUE #( %tky        = travel-%tky
                            %msg        = NEW YCM_rap_0631( severity = if_abap_behv_message=>severity-error
                                                            textid   = YCM_rap_0631=>unauthorized )
                          ) TO reported-travel.
          ENDIF.
  ...
  METHOD is_create_granted.
    AUTHORITY-CHECK OBJECT 'YOSTAT0631'
           ID 'YOSTAT0631' DUMMY
           ID 'ACTVT' FIELD '01'.
  ...
  METHOD is_delete_granted.
    IF has_before_image = abap_true.
      AUTHORITY-CHECK OBJECT 'YOSTAT0631'
        ID 'YOSTAT0631' FIELD overall_status
        ID 'ACTVT' FIELD '06'.
    ELSE.
      AUTHORITY-CHECK OBJECT 'YOSTAT0631'
        ID 'YOSTAT0631' DUMMY
